...
| `pf_artifact_blend_v31` | Conservative top-family ensemble: 85% v16 + 15% v21, equivalent to no-exact PF/artifact 79.25/20.75 and no contact | Check whether the two best no-exact blend points average into a small LB gain | no local rerun; algebraic ensemble of prior submissions | pending | Submit once as a low-risk ensemble check, not a breakthrough path |
