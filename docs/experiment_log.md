...
| `pf_artifact_blend_v23` | No-exact artifact; scalar 80/20 except `00e12e8b` at 75/25 | Component-gap audit shows PF is about 21 ft above artifact on `00e12e8b`, while the other two wells have much smaller component gaps | pending | Per-well probe: isolate the likely useful part of the global 75/25 near-tie without moving `000d7d20` and `00bbac68` |
| `pf_artifact_blend_v24` | No-exact artifact; scalar 80/20 except `00e12e8b` at 70/30 | Stronger e12-only version of v23 | pending | Directional probe: if v23 helps, this tests whether more artifact on `00e12e8b` is worth optimizing |
