...
| `pf_artifact_blend_v18` | No-exact artifact, 85/15 PF/artifact blend | Re-bracket the blend weight after removing exact overlap | notebook complete, not submitted | Submit after quota reset |
| `pf_artifact_blend_v19` | No-exact artifact, 82.5/17.5 PF/artifact blend | Re-bracket the blend weight after removing exact overlap | notebook complete, not submitted | Submit after quota reset |
| `pf_artifact_blend_v20` | No-exact artifact, 77.5/22.5 PF/artifact blend | Re-bracket the blend weight after removing exact overlap | notebook complete, not submitted | Submit after quota reset |
| `pf_artifact_blend_v21` | No-exact artifact, 75/25 PF/artifact blend | Wider right-side check for the no-exact artifact optimum | notebook complete, not submitted | Submit after quota reset |
