"""Build the fully calibrated rank-mod-8 C1 candidate."""
...
SLUG = "rogii-hmm010-c1r8-calibrated"
BIN_ALPHAS = (0.55, -0.325, 0.125, 0.70, 0.55, -0.675, 0.125, 0.475)


def main() -> None:
    output = build_c1_partition_calibrated(BIN_ALPHAS, SLUG)
